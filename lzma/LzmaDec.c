...
/* [cooViewer] use the SDK's arm64 assembler decoder (LzmaDecOpt.S) on Apple builds */
#if defined(__aarch64__) && defined(__APPLE__) && !defined(Z7_LZMA_DEC_OPT)
#define Z7_LZMA_DEC_OPT
#endif
